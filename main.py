...
from email_sender import generate_code, send_code_confirmation_email, send_confirmation_email
from user_manager import hash_password,register_user , verify_login , reset_password ,load_users
...
class ModernWindow(QMainWindow):
    ...
    def create_image_widget(self, path, right=True):
        label = QLabel()
        pixmap = QPixmap(path)
        pixmap = pixmap.scaled(500, 600, Qt.AspectRatioMode.KeepAspectRatioByExpanding, Qt.TransformationMode.SmoothTransformation)
